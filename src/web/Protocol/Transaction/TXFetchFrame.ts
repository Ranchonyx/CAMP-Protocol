...
export class TXFetchFrame {
    public static Deserialize(value: CryoBuffer): TXFetchMessage {
    ...
    public static Serialize(sid: bigint, ack: number, start: number, end: number): CryoBuffer {
        const msg_buf = CryoBuffer.alloc(8 + 1 + 4 + 4 + 4);
