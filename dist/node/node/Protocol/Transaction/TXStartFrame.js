import { CAMPFrameType, CAMP_FLOW_BEHAVIOUR, CAMP_MAX_PAYLOAD, DeserializationError, SerializationError } from "../../../protocol_base.js";
export class TXStartFrame {
    ...
    static Serialize(sid, ack, txId, name = "anonymous", byteLength = -1n, behaviour = CAMP_FLOW_BEHAVIOUR.TX_PUSH) {
