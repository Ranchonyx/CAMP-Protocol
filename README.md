...
- [CAMP client library in TypeScript under modern browsers](https://github.com/Ranchonyx/CAMP-Client-Browser)
- [CAMP client library in TypeScript under Node.Js](https://github.com/Ranchonyx/CAMP-Client-Node)
